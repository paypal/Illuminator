...
open class XCTUIBridge: NSObject {
    ...
    static open func sendNotification(_ identifier: NSString) {
        CFNotificationCenterPostNotification(CFNotificationCenterGetDarwinNotifyCenter(), CFNotificationName(rawValue: identifier as CFString), nil, nil, true)
    }
